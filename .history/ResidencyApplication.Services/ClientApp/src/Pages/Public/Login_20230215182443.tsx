...
const Login = () => {
	...
	return (
		<Layout>
			...
			{(loginstate?.isLoggedIn && loginstate.userInfo?.isAdmin && loginstate.userInfo.userRoleId == 1) &&
				<Redirect
					to={{
			...
			{(loginstate.userInfo?.userTypeId!=26)&&(loginstate.userInfo?.nationalityId?.toLowerCase()!="kw") &&
				<Redirect
					to={{
