            ...
            {authenticationState.isLoggedIn ?
              ...
              &nbsp;&nbsp;</a>
                <div className="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                  ...
                  <NavLink to="/Client/newapp" className="dropdown-item sb-nav-link-icon" onClick={()=>ClearState()}  >
                  ...
                  {(authenticationState.userInfo?.userRoleId==1||authenticationState.userInfo?.userRoleId==3)  &&
                    <NavLink to="/Res/CommonPages/LandingPage" className="dropdown-item sb-nav-link-icon" onClick={() => history.push("/Landingpage") }>
                      <i className="fas fa-angle-double-left" />&nbsp;&nbsp; مسئول النظام
                  </NavLink>}
                  <NavLink to="/Public/login" className="dropdown-item sb-nav-link-icon" onClick={logout} >
